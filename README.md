...
7. Η συνάρτηση viewOrderHistory()  
...
8. Η συνάρτηση showCart()  
   Για κάθε προϊόν που υπάρχει στο καλάθι αγορών, τυπώνεται η ποσότητα και ο τίτλος του προϊόντος. Τέλος, τυπώνεται και το συνολικό κόστος του καλαθιού (χωρίς να έχουν εφαρμοστεί ακόμα οι όποιες διαθέσιμες εκπτώσεις προκύψουν. Ο χρήστης μπορεί να δει την τελική τιμή μαζί με τις εκπτώσεις στο ιστορικό παραγγελιών. Κι αυτό, γιατί μία έκπτωση μπορεί να εφαρμοστεί, μόνον εφόσον ολοκληρωθεί η παραγγελία).
---
